...
export default function UnitType() {
	return (
		<>
			<Seo title="Jr. 1 Bedroom" />

			<main className="page__unit-type">
				<div className="page-intro">
					<div className="wrap--wide">
						<p>Our most streamlined option, distills the popular 'starter home' down to its purest essentials.</p>
				...
				<div className="wrap--narrow">
					...
					<div className="actions">
						<Link href="/home-selection?type=Jr. 1 Bedroom">
